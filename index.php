...
<!-- Create the image related divs -->
		...
		if($result){
			...
			while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
				...
				echo "<iframe width='400' height='300' frameborder='0' style='border:0' src='https://www.google.com/maps/embed/v1/place?key=AIzaSyCF0hDRT_j15Ml0rNyprSAPHQOC3vRj5_8&center=-33.8569,151.2152&zoom=18&maptype=satellite' allowfullscreen></iframe>";
