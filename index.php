...
<!-- Create the image related divs -->
		...
		if($result){
			...
			while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
				...
				echo "<iframe width='400' height='300' frameborder='0' style='border:0' src='https://www.google.com/maps/embed/v1/view?key=AIzaSyCF0hDRT_j15Ml0rNyprSAPHQOC3vRj5_8&center=".$line[Latitude].",".$line[Longitude]."&zoom=20&maptype=satellite' allowfullscreen></iframe>";
				echo "</div><!-- ".$line[uuid]." -->\r\n";
